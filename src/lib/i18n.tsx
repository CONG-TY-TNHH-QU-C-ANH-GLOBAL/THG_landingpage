...
const translations: Translations = {
  ...
  // ── Careers Page ──
  "careers.hero_badge": { en: "Join THG Fulfill", vi: "Gia nhập THG Fulfill", zh: "加入 THG Fulfill" },
  "careers.hero_title": { en: "Beyond Co-workers,", vi: "Không chỉ là đồng nghiệp,", zh: "不仅是同事，" },
  "careers.hero_title2": { en: "We are ", vi: "Chúng ta là ", zh: "更是" },
  "careers.hero_title_highlight": { en: "Partners", vi: "Đối tác", zh: "合作伙伴" },
  ...
  "careers.stats_positions": { en: "Open Positions", vi: "Vị trí đang tuyển", zh: "热招职位" },
  "careers.stats_depts": { en: "Departments", vi: "Bộ phận", zh: "核心部门" },

  "careers.why_eyebrow": { en: "Why Choose THG", vi: "Tại sao chọn THG", zh: "为什么选择THG" },
  "careers.why_title": { en: "Environment & Culture", vi: "Môi trường & Văn hóa", zh: "环境与文化" },
  ...
  "careers.view_details": { en: "Job Details", vi: "Xem thêm", zh: "职缺详情" },
  ...
  "careers.modal_apply_desc": { en: "Send your CV and application to <strong class=\"text-[hsl(var(--gold))]\">hr@thgfulfill.com</strong><br />Interview Location: 121/5 Kenh 19/05, Tay Thanh Ward, HCMC", vi: "Gửi CV và đơn ứng tuyển về <strong class=\"text-[hsl(var(--gold))]\">hr@thgfulfill.com</strong><br />Địa điểm phỏng vấn: 121/5 Kênh 19/05, Phường Tây Thạnh, TP.HCM", zh: "将简历及求职信发送至 <strong class=\"text-[hsl(var(--gold))]\">hr@thgfulfill.com</strong><br />面试地点：胡志明市新富郡西盛坊19/05渠街121/5号" },
  ...
  "careers.cta_desc": { en: "Send your CV and your aspirations to <strong class=\"text-[hsl(var(--gold))]\">hr@thgfulfill.com</strong> — THG is always open for exceptional talents.", vi: "Gửi CV cùng mong muốn của bạn về <strong class=\"text-[hsl(var(--gold))]\">hr@thgfulfill.com</strong> — THG luôn mở cửa với những tài năng xuất sắc.", zh: "将简历及期望发送至 <strong class=\"text-[hsl(var(--gold))]\">hr@thgfulfill.com</strong> — THG 始终欢迎优秀人才加盟。" },
  ...
  // Jobs
  "careers.j1_badge": { en: "🤖 AI R&D · Internship", vi: "🤖 AI R&D · Internship", zh: "🤖 AI研发 · 实习" },
  "careers.j1_tagline": { en: "\"Building the AI layer for cross-border fulfillment.\"", vi: "\"Xây dựng lớp AI cho hệ sinh thái fulfillment xuyên biên giới.\"", zh: "\"为跨境履约生态构建AI层\"" },
  "careers.j1_title": { en: "AI Research Intern", vi: "Thực tập sinh Nghiên cứu AI", zh: "AI研究实习生" },
  "careers.j1_desc": { en: "R&D of AI solutions for practical operations at THG — from Customer Care AI Agents to automated sourcing on 1688.", vi: "Tham gia R&D các giải pháp AI ứng dụng vào vận hành thực tế của THG — từ AI Agent chăm sóc khách đến tool sourcing tự động trên 1688/Taobao.", zh: "研发THG实际运营中的AI解决方案——从客户服务AI Agent到自动化采购工具。" },
  "careers.j1_salary": { en: "2 million VND", vi: "2 triệu", zh: "200万越南盾" },
  "careers.j1_salaryUnit": { en: "+ project bonus", vi: "+ thưởng theo dự án", zh: "+ 项目奖金" },
  "careers.j1_salaryNote": { en: "1-1 Mentor with CEO · Real AI projects", vi: "Mentor 1-1 với CEO · Cơ hội làm dự án AI thực tế", zh: "与CEO的1-1导师指导 · 实际AI项目" },
  "careers.j1_location": { en: "HCMC · Hybrid", vi: "TP.HCM · Hybrid", zh: "胡志明市 · 混合" },
  "careers.j1_type": { en: "Intern 3-6 mos", vi: "Internship 3–6 tháng", zh: "实习 3-6个月" },
  "careers.j1_exp": { en: "Not req", vi: "Không bắt buộc", zh: "不限" },

  "careers.j2_badge": { en: "Accounting · Finance", vi: "Kế toán · Finance", zh: "财务 · 会计" },
  "careers.j2_tagline": { en: "\"The keeper of the books for the whole ecosystem.\"", vi: "\"Người giữ sổ sách cho cả hệ sinh thái.\"", zh: "\"整个生态系统的财务管家\"" },
  "careers.j2_title": { en: "Accountant", vi: "Nhân viên Kế toán", zh: "会计专员" },
  "careers.j2_desc": { en: "Manage revenues, expenses, debts and support HR. A crucial role in the financial mechanism.", vi: "Quản lý thu chi, công nợ và hỗ trợ nhân sự cho đội ngũ THG Fulfill. Vị trí then chốt trong bộ máy tài chính.", zh: "管理收支、债务及协助人事。财务机制中的关键角色。" },
  "careers.j2_salary": { en: "10 million VND", vi: "10 triệu", zh: "1000万越南盾" },
  "careers.j2_salaryUnit": { en: "+ performance bonus", vi: "+ thưởng hiệu suất", zh: "+ 绩效奖金" },
  "careers.j2_salaryNote": { en: "Actual income higher than base salary", vi: "Thu nhập thực nhận cao hơn lương cứng", zh: "实际收入高于底薪" },
  "careers.j2_location": { en: "HCMC", vi: "TP.HCM", zh: "胡志明市" },
  "careers.j2_type": { en: "Full-time", vi: "Full-time", zh: "全职" },
  "careers.j2_exp": { en: "2+ years", vi: "Từ 2 năm", zh: "2年以上" },

  "careers.j3_badge": { en: "Sales · POD / Dropship", vi: "Sales · POD / Dropship", zh: "销售 · POD/代发" },
  "careers.j3_tagline": { en: "\"The bridge between Global Sellers and CN/VN Factories.\"", vi: "\"Cầu nối giữa Seller toàn cầu và nhà máy Việt – Trung.\"", zh: "\"连接全球卖家与中越工厂的桥梁\"" },
  "careers.j3_title": { en: "POD / Dropship Sales Executive", vi: "Nhân viên Sales POD / Dropship", zh: "POD / 代发销售专员" },
  "careers.j3_desc": { en: "Acquire POD/Dropship Sellers from VN/CN shipping to US & EU.", vi: "Phát triển khách hàng Seller bán POD, Dropship từ Việt Nam và Trung Quốc đi Mỹ, Châu Âu.", zh: "开发向欧美发货的中越POD/Dropship卖家客户。" },
  "careers.j3_salary": { en: "8 million VND", vi: "8 triệu", zh: "800万越南盾" },
  "careers.j3_salaryUnit": { en: "+ commission", vi: "+ hoa hồng + thưởng", zh: "+ 佣金" },
  "careers.j3_salaryNote": { en: "Unlimited income based on performance", vi: "Thu nhập không giới hạn theo hiệu suất", zh: "收入上不封顶" },
  "careers.j3_location": { en: "HCMC", vi: "TP.HCM", zh: "胡志明市" },
  "careers.j3_type": { en: "Full-time", vi: "Full-time", zh: "全职" },
  "careers.j3_exp": { en: "Not req", vi: "Không bắt buộc", zh: "不限" },

  "careers.j4_badge": { en: "Sales · Logistics", vi: "Sales · Vận chuyển E-commerce", zh: "销售 · 跨境物流" },
  "careers.j4_tagline": { en: "\"The cross-border shipping expert.\"", vi: "\"Chuyên gia tuyến vận chuyển xuyên biên giới.\"", zh: "\"跨境运输专家\"" },
  "careers.j4_title": { en: "International Shipping Sales Executive", vi: "Nhân viên Sales Vận chuyển Quốc tế", zh: "国际物流销售专员" },
  "careers.j4_desc": { en: "Consult on E-commerce shipping packages for sellers on TikTok Shop US, Shopify, Amazon...", vi: "Tư vấn gói cước vận chuyển Ecommerce cho Seller trên TikTok Shop US, Shopify, Amazon, Etsy...", zh: "为TikTok Shop US、Shopify等卖家提供跨境电商物流咨询及报价方案。" },
  "careers.j4_salary": { en: "8 million VND", vi: "8 triệu", zh: "800万越南盾" },
  "careers.j4_salaryUnit": { en: "+ commission", vi: "+ hoa hồng + thưởng", zh: "+ 佣金" },
  "careers.j4_salaryNote": { en: "Unlimited income based on performance", vi: "Thu nhập không giới hạn theo hiệu suất", zh: "收入上不封顶" },
  "careers.j4_location": { en: "HCMC", vi: "TP.HCM", zh: "胡志明市" },
  "careers.j4_type": { en: "Full-time", vi: "Full-time", zh: "全职" },
  "careers.j4_exp": { en: "Not req", vi: "Không bắt buộc", zh: "不限" },

  "careers.j5_badge": { en: "Sales · US Warehouse", vi: "Sales · Warehouse US", zh: "销售 · 美国仓储" },
  "careers.j5_tagline": { en: "\"Bringing products to the US soil.\"", vi: "\"Người đưa hàng Việt vào kho Mỹ.\"", zh: "\"将中越产品带入美国本土\"" },
  "careers.j5_title": { en: "US Warehouse Sales Executive", vi: "Nhân viên Sales Warehouse Mỹ", zh: "美国仓储销售专员" },
  "careers.j5_desc": { en: "Develop warehousing and fulfillment clients in the US — THG's strategic segment.", vi: "Phát triển khách hàng cho dịch vụ kho bãi và fulfillment tại Mỹ — mảng chiến lược của THG.", zh: "开发美国仓储与履约服务客户——THG的战略核心业务。" },
  "careers.j5_salary": { en: "8 million VND", vi: "8 triệu", zh: "800万越南盾" },
  "careers.j5_salaryUnit": { en: "+ commission", vi: "+ hoa hồng + thưởng", zh: "+ 佣金" },
  "careers.j5_salaryNote": { en: "Unlimited income based on performance", vi: "Thu nhập không giới hạn theo hiệu suất", zh: "收入上不封顶" },
  "careers.j5_location": { en: "HCMC", vi: "TP.HCM", zh: "胡志明市" },
  "careers.j5_type": { en: "Full-time", vi: "Full-time", zh: "全职" },
  "careers.j5_exp": { en: "Not req", vi: "Không bắt buộc", zh: "不限" },

  "careers.j6_badge": { en: "Operations", vi: "Operations · Vận hành", zh: "运营操作" },
  "careers.j6_tagline": { en: "\"The backbone of our fulfillment engine.\"", vi: "\"Xương sống của bộ máy fulfillment.\"", zh: "\"履约引擎的核心骨干\"" },
  "careers.j6_title": { en: "E-Commerce Operations Executive", vi: "Nhân viên Vận hành TMĐT", zh: "电商运营专员" },
  "careers.j6_desc": { en: "Purchasing, shipping & Dropship operations on 1688 / Alibaba.", vi: "Mua hàng, vận chuyển và xử lý đơn Dropship từ 1688 / Alibaba. Vai trò xương sống của bộ máy vận hành.", zh: "在1688/Alibaba平台上进行采购、物流及代发业务运营。" },
  "careers.j6_salary": { en: "10 million VND", vi: "10 triệu", zh: "1000万越南盾" },
  "careers.j6_salaryUnit": { en: "+ commission", vi: "+ hoa hồng + thưởng", zh: "+ 佣金" },
  "careers.j6_salaryNote": { en: "Unlimited income based on performance", vi: "Thu nhập không giới hạn theo hiệu suất", zh: "收入上不封顶" },
  "careers.j6_location": { en: "HCMC", vi: "TP.HCM", zh: "胡志明市" },
  "careers.j6_type": { en: "Full-time", vi: "Full-time", zh: "全职" },
  "careers.j6_exp": { en: "From 6 mos", vi: "Từ 6 tháng", zh: "提6个月" },

  "careers.j7_badge": { en: "Sourcing & China Desk", vi: "Ngoại giao & Báo giá", zh: "采购与中国业务" },
  "careers.j7_tagline": { en: "\"The extended arm to Chinese factories.\"", vi: "\"Cánh tay nối dài đến các nhà máy Trung Quốc.\"", zh: "\"深入中国工厂的桥梁\"" },
  "careers.j7_title": { en: "China Desk Executive", vi: "Nhân viên Ngoại giao & Báo giá (China Desk)", zh: "中国业务及报价专员 (China Desk)" },
  "careers.j7_desc": { en: "Work directly with factories and suppliers in China — acting as the bridge for THG.", vi: "Làm việc trực tiếp với nhà máy và supplier Trung Quốc — cầu nối giữa THG và hệ sinh thái sản xuất TQ.", zh: "直接对接中国工厂和供应商——THG与中国生产生态系统的重要桥梁。" },
  "careers.j7_salary": { en: "10 million VND", vi: "10 triệu", zh: "1000万越南盾" },
  "careers.j7_salaryUnit": { en: "+ commission", vi: "+ hoa hồng + thưởng", zh: "+ 佣金" },
  "careers.j7_salaryNote": { en: "Unlimited income based on performance", vi: "Thu nhập không giới hạn theo hiệu suất", zh: "收入上不封顶" },
  "careers.j7_location": { en: "HCMC", vi: "TP.HCM", zh: "胡志明市" },
  "careers.j7_type": { en: "Full-time", vi: "Full-time", zh: "全职" },
  "careers.j7_exp": { en: "Not req", vi: "Không bắt buộc", zh: "不限" },
