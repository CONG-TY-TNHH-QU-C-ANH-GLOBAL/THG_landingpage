...
//
// The two site-shell reads (loadContactLocations, loadSiteSettings) live in ./shell-loaders
// so the shared layout can import them without this module's homepage graph; they are
// re-exported here to keep ./loaders the single aggregate import surface for the barrel.
export { loadContactLocations, loadSiteSettings } from "./shell-loaders";
