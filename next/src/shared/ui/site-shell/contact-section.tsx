          ...
          <div>
            ...
            {physicalCount > 0 && channels.length > 0 && (
              <div className="mt-8" data-testid="contact-channels">
                <p className="text-[length:var(--step-label)] font-bold text-[hsl(var(--gold-dark))] uppercase tracking-[var(--tracking-wide)] mb-1.5">
                  {t("contact.channels")}
                </p>
      ...
      {channels.map((item) => {
        ...
        return (
          <li key={item.id} className="flex items-center gap-3 py-2.5 border-b border-border">
            ...
            <span className="text-[length:var(--step-label)] font-bold text-[hsl(var(--gold-dark))] uppercase tracking-[var(--tracking-wide)] w-24 flex-shrink-0 text-left">
              {item.label}
            </span>
            {href ? (
              <a
        ...
        return (
          <li key={item.id} className="flex gap-4 py-5 border-b border-border">
            ...
            <div className="min-w-0">
              <p className="text-[length:var(--step-label)] font-bold text-[hsl(var(--gold-dark))] uppercase tracking-[var(--tracking-wide)] mb-1">
                {item.label}
              </p>
